/*	Look through Lesson 15b Advanced Subqueries.sql and run the code examples there, 
...
/* 8) Use the WITH clause to find those managers who manage a larger than 
      ...
      and how many employees report to them. Remember, there is a null manager. 
      Include it in your calculations. Use an id of 999 for it. */
